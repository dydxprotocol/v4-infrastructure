...
locals {
  services = {
    "${local.service_names["ender"]}" : {
      ...
      task_definition_cpu : var.ender_task_definition_cpu,
      is_public_facing : false,
      ports : [8080],
      health_check_port : 8080,
      deployment_maximum_percent : var.ender_deployment_maximum_percent,
      deployment_minimum_healthy_percent : var.ender_deployment_minimum_healthy_percent,
    ...
    "${local.service_names["comlink"]}" : {
      ...
      deployment_minimum_healthy_percent : var.comlink_deployment_minimum_healthy_percent,
      availability_zone_rebalancing : var.comlink_availability_zone_rebalancing,
    ...
    "${local.service_names["socks"]}" : {
      ...
      task_definition_memory : var.socks_task_definition_memory,
      task_definition_cpu : var.socks_task_definition_cpu,
      is_public_facing : true,
      ports : [8080, 8000],
      health_check_port : 8000,
      deployment_maximum_percent : 200,
      deployment_minimum_healthy_percent : var.socks_deployment_minimum_healthy_percent,
      availability_zone_rebalancing : var.socks_availability_zone_rebalancing,
      requires_kafka_connection : true,
      requires_postgres_connection : true,
    ...
    "${local.service_names["roundtable"]}" : {
      ecs_desired_count : var.roundtable_ecs_desired_count,
      task_definition_memory : 4096,
      task_definition_cpu : 2048,
      is_public_facing : false,
      ports : [8080],
      health_check_port : 8080,
      deployment_maximum_percent : var.roundtable_deployment_maximum_percent,
      deployment_minimum_healthy_percent : var.roundtable_deployment_minimum_healthy_percent,
      availability_zone_rebalancing : var.ecs_availability_zone_rebalancing,
      requires_kafka_connection : true,
      requires_postgres_connection : true,
      requires_redis_connection : true,
    ...
    "${local.service_names["vulcan"]}" : {
      ...
      health_check_port : 8080,
      deployment_maximum_percent : 200,
      deployment_minimum_healthy_percent : var.vulcan_deployment_minimum_healthy_percent,
      availability_zone_rebalancing : var.ecs_availability_zone_rebalancing,
      requires_kafka_connection : true,
      requires_postgres_connection : true,
      requires_redis_connection : true,
